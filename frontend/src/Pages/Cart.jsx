    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 py-12 px-4 md:px-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="md:col-span-2 bg-white shadow-lg rounded-2xl p-6">
          <h2 className="text-3xl font-bold text-blue-700 mb-6 border-b border-blue-200 pb-3">
            Your Cart
          </h2>
            ...
            <table className="min-w-full text-sm text-gray-700">
              ...
              <tbody>
                ...
                <tr className="hover:bg-blue-50 border-b">
                  ...
                  <td className="py-4 font-medium">Sample Product</td>
                  <td className="py-4">
                    <div className="flex items-center gap-2">
                      <button className="bg-blue-100 text-blue-800 px-3 py-1 rounded hover:bg-blue-200 transition">
                        -
                      </button>
                  ...
                  <td className="py-4 font-semibold text-blue-700">$49.99</td>
        ...
        {/* Summary & Shipping */}
        <div className="bg-white shadow-lg rounded-2xl p-6 space-y-8 sticky top-20 h-fit">
          {/* Summary */}
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <input
                  type="text"
                  placeholder="City"
                  className="w-1/2 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300"
                />
                <input
                  type="text"
                  placeholder="ZIP"
          ...
          {/* Place Order */}
          <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-md shadow-md transition duration-200">
            Place Order
          </button>
        </div>
      </div>
