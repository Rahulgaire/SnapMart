  ...
  return (
    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          Get farm-fresh fruits, vegetables, dairy, and more. Order online and we’ll deliver within minutes.
        </motion.p>
        ...
        >
          <Link to="/products">
            <button className="w-60 transform rounded-lg bg-green-600 px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-green-700 dark:bg-white dark:text-black dark:hover:bg-gray-200">
              Start Shopping
            </button>
          </Link>
        ...
        >
          <div className="w-full overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700">
            <img
              src="https://images.unsplash.com/photo-1515706886582-54c73c5eaf41?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
