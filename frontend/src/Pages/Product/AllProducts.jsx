  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    {currentItems.map((product) => (
      <div
        key={product._id}
        className="
          bg-blue-50 rounded-lg border border-blue-300 shadow-md 
          hover:shadow-xl hover:border-blue-500 transform hover:-translate-y-1 transition duration-300
          flex flex-col
        "
      >
        ...
        <div className="p-4 flex flex-col flex-grow">
          <h2
            className="font-semibold text-xl text-blue-900 truncate mb-1"
            title={product.title}
          >
            {product.title}
          </h2>

          <p className="text-blue-700 text-sm mb-3 line-clamp-3">
            {product.description}
          </p>
